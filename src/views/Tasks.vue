              ...
              <h2 class="text-2xl font-bold mb-4 text-[#febd2f]">Task backlog</h2>
                ...
                <div   v-for="task in pendingTasks" :key="task.title" class="p-4 bg-[#febd2f] rounded-md text-gray-800 ">
                  <div class="flex justify-between">
                    ...
                    <span @click="deleteItem(task.id)" class="cursor-pointer bg-rose-500 rounded-lg text-white py-1 px-1 text-xs ">
                  ...
                  <div class="text-sm text-gray-900 font-kalam">
                    ...
                    <div class="flex justify-between">
                      ...
                      <span class="cursor-pointer bg-[#2a3240] rounded-lg text-white py-1 px-1" >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
